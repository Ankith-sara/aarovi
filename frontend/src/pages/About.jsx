...
const About = () => {
  ...
  return (
    <div className="min-h-screen">
      <section className="relative bg-[#FBF7F3] px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-text mb-6" style={{ fontFamily: "'Cormorant Garamond',Georgia,serif" }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl sm:text-4xl font-serif font-bold text-text mb-6" style={{ fontFamily: "'Cormorant Garamond',Georgia,serif" }}>Where Tradition Meets Contemporary Style</h2>
              ...
              <div className="mt-8 p-6 bg-gradient-to-br from-[#FBF7F3]/20 to-[#FBF7F3]/5 rounded-2xl border-l-4 border-[#4F200D]">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <Heart size={20} className="text-[#4F200D]" />
                  </div>
                  <div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-white to-[#FBF7F3]/20 rounded-3xl p-12 border border-[#FBF7F3]/50 shadow-xl text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#4F200D]/10 rounded-full mb-6">
              <Sparkles size={14} className="text-[#4F200D]" />
              <span className="text-xs font-semibold text-[#4F200D] uppercase tracking-wider">Start Your Journey</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-text mb-4" style={{ fontFamily: "'Cormorant Garamond',Georgia,serif" }}> Experience Aarovi</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button onClick={() => handleNavigate('/shop/collection')} className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#4F200D] text-white font-semibold rounded-full hover:bg-[#4F200D]/90 transition-all duration-300 shadow-xl shadow-[#4F200D]/30 hover:shadow-2xl hover:shadow-[#4F200D]/40 hover:-translate-y-0.5">
                <span>Explore Collection</span>
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </button>
              <button onClick={() => handleNavigate('/contact')} className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white border-2 border-[#FBF7F3]/50 text-text font-semibold rounded-full hover:border-[#4F200D] hover:shadow-lg transition-all duration-300">
