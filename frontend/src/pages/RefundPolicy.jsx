...
const CancellationRefundPolicy = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#FBF7F3]/10 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white rounded-2xl p-6 text-center border border-[#FBF7F3]/50 hover:shadow-lg transition-all">
              <Clock className="w-8 h-8 text-[#4F200D] mx-auto mb-3" />
              <div className="text-3xl font-bold text-text mb-1">6 Hours</div>
              <div className="text-sm text-text/60">Cancellation Window</div>
            </div>
            <div className="bg-white rounded-2xl p-6 text-center border border-[#FBF7F3]/50 hover:shadow-lg transition-all">
              <AlertCircle className="w-8 h-8 text-[#4F200D] mx-auto mb-3" />
              <div className="text-3xl font-bold text-text mb-1">2 Days</div>
              <div className="text-sm text-text/60">Report Issues</div>
            </div>
            <div className="bg-white rounded-2xl p-6 text-center border border-[#FBF7F3]/50 hover:shadow-lg transition-all">
              <Package className="w-8 h-8 text-[#4F200D] mx-auto mb-3" />
              <div className="text-3xl font-bold text-text mb-1">7 Days</div>
              <div className="text-sm text-text/60">Final Deadline</div>
            </div>
            <div className="bg-white rounded-2xl p-6 text-center border border-[#FBF7F3]/50 hover:shadow-lg transition-all">
              <XCircle className="w-8 h-8 text-[#4F200D] mx-auto mb-3" />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-[#4F200D]/5 to-primary rounded-2xl p-8 border border-[#4F200D]/20">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-[#4F200D]/10 rounded-full flex items-center justify-center flex-shrink-0">
                <Info className="w-6 h-6 text-[#4F200D]" />
              </div>
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-white rounded-full text-sm font-semibold text-text border border-[#FBF7F3]/50">
                    No Refunds
                  </span>
                  <span className="px-4 py-2 bg-white rounded-full text-sm font-semibold text-text border border-[#FBF7F3]/50">
                    Exchange Only
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-[#FBF7F3]/10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-text mb-3" style={{ fontFamily: "'Cormorant Garamond',Georgia,serif" }}>Policy Details</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 1 </div>
                <div className="flex-1">
                  <h3 className="font-serif font-bold text-text text-lg mb-2 flex items-center gap-2">
                    <Clock className="w-5 h-5 text-[#4F200D]" />
            ...
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 2 </div>
                <div className="flex-1">
                  <h3 className="font-serif font-bold text-text text-lg mb-2 flex items-center gap-2">
                    <XCircle className="w-5 h-5 text-[#4F200D]" />
                    No Refunds Policy
                  </h3>
                  <p className="text-text/70 text-sm leading-relaxed">
            ...
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 3 </div>
                <div className="flex-1">
                  <h3 className="font-serif font-bold text-text text-lg mb-2 flex items-center gap-2">
                    <Shield className="w-5 h-5 text-[#4F200D]" />
                    Handcrafted Nature
                  </h3>
                  <p className="text-text/70 text-sm leading-relaxed">
            ...
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 4 </div>
                <div className="flex-1">
                  <h3 className="font-serif font-bold text-text text-lg mb-2 flex items-center gap-2">
                    <AlertCircle className="w-5 h-5 text-[#4F200D]" />
            ...
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 5 </div>
                <div className="flex-1">
                  <h3 className="font-serif font-bold text-text text-lg mb-2 flex items-center gap-2">
                    <Package className="w-5 h-5 text-[#4F200D]" />
                    Return Conditions
                  </h3>
                  <p className="text-text/70 text-sm leading-relaxed">
            ...
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 6 </div>
                <div className="flex-1">
                  ...
                  <div className="bg-[#FBF7F3]/30 p-4 rounded-xl space-y-2">
                    <div className="flex items-center gap-2 text-xs text-text/70">
                      <div className="w-1.5 h-1.5 bg-[#4F200D] rounded-full"></div>
            ...
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 7 </div>
                <div className="flex-1">
                  <h3 className="font-serif font-bold text-text text-lg mb-2 flex items-center gap-2">
                    <RotateCcw className="w-5 h-5 text-[#4F200D]" />
                    Size Exchanges
                  </h3>
                  <p className="text-text/70 text-sm leading-relaxed">
            ...
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 8 </div>
                <div className="flex-1">
                  <h3 className="font-serif font-bold text-text text-lg mb-2 flex items-center gap-2">
                    <CheckCircle className="w-5 h-5 text-[#4F200D]" />
                    Replacement Process
                  </h3>
                  <p className="text-text/70 text-sm leading-relaxed">
            ...
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 9 </div>
                <div className="flex-1">
                  <h3 className="font-serif font-bold text-text text-lg mb-2 flex items-center gap-2">
                    <AlertCircle className="w-5 h-5 text-[#4F200D]" />
                    Do Not Self-Ship
            ...
            <div className="group bg-white rounded-2xl p-6 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-[#4F200D]/80 text-white rounded-xl flex items-center justify-center font-bold text-lg flex-shrink-0 group-hover:scale-110 transition-transform"> 10 </div>
                <div className="flex-1">
                  <h3 className="font-serif font-bold text-text text-lg mb-2 flex items-center gap-2">
                    <Clock className="w-5 h-5 text-[#4F200D]" />
                    Contact Deadline
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <RotateCcw className="w-10 h-10 mx-auto mb-4 text-[#4F200D]" />
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-text mb-3" style={{ fontFamily: "'Cormorant Garamond',Georgia,serif" }}>How to Request an Exchange</h2>
            <p className="text-text/60 max-w-2xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="relative bg-white rounded-2xl p-8 border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="absolute -top-4 left-8">
                <div className="w-12 h-12 bg-[#4F200D] text-white rounded-full flex items-center justify-center font-bold text-xl shadow-lg">
                  1
                </div>
              </div>
              <div className="mt-6">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#FBF7F3]/10 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <XCircle className="w-10 h-10 mx-auto mb-4 text-[#4F200D]" />
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-text mb-3" style={{ fontFamily: "'Cormorant Garamond',Georgia,serif" }}>Items We Cannot Exchange</h2>
            <p className="text-text/60 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-2xl border border-[#FBF7F3]/50 hover:shadow-lg transition-all">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#4F200D] rounded-full mt-2 flex-shrink-0"></div>
                  <div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-text mb-4" style={{ fontFamily: "'Cormorant Garamond',Georgia,serif" }}>Need Help With Your Order?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white rounded-2xl p-8 text-center border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="w-16 h-16 bg-[#4F200D]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Phone className="w-8 h-8 text-[#4F200D]" />
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 text-center border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="w-16 h-16 bg-[#4F200D]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Mail className="w-8 h-8 text-[#4F200D]" />
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 text-center border border-[#FBF7F3]/50 hover:shadow-xl transition-all">
              <div className="w-16 h-16 bg-[#4F200D]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <AlertCircle className="w-8 h-8 text-[#4F200D]" />
              </div>
              <h4 className="font-serif font-bold text-text mb-3 text-lg">Deadline</h4>
              <p className="text-4xl font-serif text-[#4F200D] font-bold mb-2">7 Days</p>
              <p className="text-sm text-text/60">From delivery date</p>
            </div>
          </div>

          <div className="bg-gradient-to-br from-secondary to-[#4F200D]/90 text-white p-10 rounded-2xl max-w-4xl mx-auto text-center shadow-xl">
